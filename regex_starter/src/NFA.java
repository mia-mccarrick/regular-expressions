...
public class NFA{
	...
	public void star(){
		...
		for(int finalState: this.finalStates){
			addTransition(finalState, 'e', this.startState);
			addTransition(this.startState, 'e', finalState); //accept an empty string
		}
		this.finalStates.add(this.startState);
	}
	...
	public void union(NFA other){
		...
		addTransition(newStartState, 'e', this.startState);
		addTransition(newStartState, 'e', other.getStartState());
	...
	public void concatenate(NFA other){
		...
		for(int state : this.finalStates){
			addTransition(state, 'e', other.getStartState());
		}
